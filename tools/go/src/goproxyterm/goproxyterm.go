...
import (
	...
	"salsanci.com/propforth/src/telnetFilter"
)
...
func main() {
	...
	*/
	...
	serafcFilter.LogChan = conLog
	serafcFilter.Debug = intargs[2]&1 != 0

	chanFromProtocol, chanToProtocol := serafcFilter.ProtocolFilter(chanFromSerial, chanToSerial)
